...
export class SidebarComponent implements OnInit, OnDestroy {
  ...
  //   //fetch the country saved in the cookie storage, and use it as a filter
  //   // const getReceivedSubsidiary = () => {
  //   //   const cookieValue = getCookie('selected_Subsidiary');
  //   //   return JSON.parse(cookieValue) || null;
  //   // };
  //   // console.log(`getReceivedSubsidiary ${JSON.stringify(getReceivedSubsidiary())}`);
  //   // this.received_Subsidiary = getReceivedSubsidiary();
  ...
  //     // this.sidebarItems = ROUTES.filter((x) => this.canView(x));
  //   }
  ...
  //   //printing everything in the local storage:
